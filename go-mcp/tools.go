...
type Args struct {
	Entity string         `json:"entity" jsonschema:"currency | exchange_rate"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EuroRatesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "euro-rates_list",
		Description: "List records from EuroRates. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "euro-rates_load",
		Description: "Load a single record from EuroRates. " +
...
func runOp(client *sdk.EuroRatesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EuroRatesSDK, name string) (sdk.EuroRatesEntity, error) {
