...
The TypeScript SDK for the EuroRates API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new EuroRatesSDK({ apikey: '...' })
