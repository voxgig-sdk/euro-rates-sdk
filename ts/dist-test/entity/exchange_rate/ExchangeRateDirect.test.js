...
(0, node_test_1.describe)('ExchangeRateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EuroRatesSDK({
    ...
    (0, node_test_1.test)('direct-load-exchange_rate', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-exchange_rate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EuroRatesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['EURO_RATES_TEST_EXCHANGE_RATE_ENTID'];
    ...
    const client = new __1.EuroRatesSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ExchangeRateDirect.test.js.map