...
function envOverride(m) {
    if ('TRUE' === process.env.EURO_RATES_TEST_LIVE ||
        'TRUE' === process.env.EURO_RATES_TEST_OVERRIDE) {
    ...
    m.EURO_RATES_TEST_EXPLAIN = process.env.EURO_RATES_TEST_EXPLAIN || m.EURO_RATES_TEST_EXPLAIN;
    return m;
}
