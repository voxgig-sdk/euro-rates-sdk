...
class EuroRatesRbacFeature extends EuroRatesBaseFeature
{
    ...
    private function _required(EuroRatesContext $ctx): ?string
    {
    ...
    private function _reject(EuroRatesContext $ctx, string $required): void
    {
    ...
    private function _track(EuroRatesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
