...
class EuroRatesTimeoutFeature extends EuroRatesBaseFeature
{
    ...
    private function _with_timeout(EuroRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EuroRatesContext $_ctx, float $ms): void
    {
        $client = $this->client;
