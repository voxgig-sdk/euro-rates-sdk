...
// EuroRates SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EuroRatesTestFeature extends EuroRatesBaseFeature
{
    ...
    public function init(EuroRatesContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EuroRatesContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = EuroRatesParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EuroRatesContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EuroRatesContext $ctx, $op, $args): array
    {
