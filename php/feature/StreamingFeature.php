...
// EuroRates SDK streaming feature
...
class EuroRatesStreamingFeature extends EuroRatesBaseFeature
{
    ...
    private function _iterate(EuroRatesResult $result): \Generator
    {
    ...
    private function _streamable(EuroRatesContext $ctx): bool
    {
