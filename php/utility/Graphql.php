...
class EuroRatesGraphql
{
    ...
    // equivalent.
    public static function body(EuroRatesContext $ctx): mixed
    {
    ...
    public static function errors(EuroRatesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
