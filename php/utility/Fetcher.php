...
// EuroRates SDK utility: fetcher

class EuroRatesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EuroRatesSDK/1.0)';
    ...
    public static function call(EuroRatesContext $ctx, string $fullurl, array $fetchdef): array
    {
