...
// EuroRates SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EuroRatesMakeRequest
{
    public static function call(EuroRatesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EuroRatesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EuroRatesResponse($fetched);
        } else {
