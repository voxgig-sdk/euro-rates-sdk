...
The PHP SDK for the EuroRates API — an entity-oriented client using PHP conventions.
...
```
php/
├── eurorates_sdk.php          -- Main SDK class
...
The main class (`eurorates_sdk.php`) exports the SDK class
