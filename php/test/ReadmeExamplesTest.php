...
// EuroRates SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EuroRatesSDK::test)
...
{
    private const SDK_CLASS = 'EuroRatesSDK';
    ...
    private const SDK_BASE = 'eurorates_sdk';
