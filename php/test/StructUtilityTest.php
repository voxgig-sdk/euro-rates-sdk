...
// EuroRates SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EuroRatesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EuroRatesOmni::structfix($now, Struct::undef()))
                        !== json_encode(EuroRatesOmni::structfix($val, Struct::undef()))) {
