...
class ExchangeRateEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EURO_RATES_TEST_EXCHANGE_RATE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function exchange_rate_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EURO_RATES_TEST_EXCHANGE_RATE_ENTID");
