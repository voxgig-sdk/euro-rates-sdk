...
func (sdk *EuroRatesSDK) OptionsMap() map[string]any {
...
func (sdk *EuroRatesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EuroRatesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EuroRatesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EuroRatesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *EuroRatesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *EuroRatesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("EuroRatesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *EuroRatesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EuroRatesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("EuroRatesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
