...
const testSeed = `map[string]any{"entity": map[string]any{"currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "exchange_rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
