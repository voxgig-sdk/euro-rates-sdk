...
// EuroRates SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EuroRatesTransformResponse
{
    public static function call(EuroRatesContext $ctx): mixed
    {
        ...
        $transform = EuroRatesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
