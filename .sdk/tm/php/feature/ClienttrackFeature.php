...
// EuroRates SDK clienttrack feature
...
class EuroRatesClienttrackFeature extends EuroRatesBaseFeature
{
    ...
    public function PostConstruct(EuroRatesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EuroRates-SDK';
