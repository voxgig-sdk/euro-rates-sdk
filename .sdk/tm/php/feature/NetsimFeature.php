...
class EuroRatesNetsimFeature extends EuroRatesBaseFeature
{
    ...
    private function _simulate(EuroRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EuroRatesContext $ctx, array $applied): void
    {
        $client = $this->client;
