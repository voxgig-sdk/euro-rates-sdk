...
class EuroRatesCacheFeature extends EuroRatesBaseFeature
{
    ...
    private function _through(EuroRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
