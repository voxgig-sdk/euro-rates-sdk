...
class EuroRatesProxyFeature extends EuroRatesBaseFeature
{
    ...
    public function init(EuroRatesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EuroRatesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
