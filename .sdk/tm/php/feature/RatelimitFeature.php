...
// EuroRates SDK ratelimit feature
...
class EuroRatesRatelimitFeature extends EuroRatesBaseFeature
{
    ...
    private function _acquire(EuroRatesContext $ctx): void
    {
    ...
    private function _track(EuroRatesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
