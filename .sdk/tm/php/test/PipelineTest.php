...
{
    private static function utility(): EuroRatesUtility
    {
        return new EuroRatesUtility();
    }
    ...
    private static function ctx(array $over = []): EuroRatesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EuroRatesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EuroRatesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EuroRatesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EuroRatesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EuroRatesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EuroRatesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EuroRatesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EuroRatesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EuroRatesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EuroRatesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EuroRatesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EuroRatesResponse([]),
            'result' => new EuroRatesResult([]),
        ]);
        [, $err] = EuroRatesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new EuroRatesSpec([]),
            'response' => null,
            'result' => new EuroRatesResult([]),
        ]);
        [, $err] = EuroRatesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EuroRatesSpec(['step' => 's']),
            'response' => new EuroRatesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EuroRatesResult([]),
        ]);
        [, $err] = EuroRatesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EuroRatesSpec(['step' => 's']),
            'response' => new EuroRatesResponse(self::resp(200, ['v' => 1])),
            'result' => new EuroRatesResult([]),
        ]);
        [, $err] = EuroRatesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EuroRatesSpec(['step' => 's']),
            'response' => new EuroRatesResponse(self::resp(200, ['v' => 2])),
            'result' => new EuroRatesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EuroRatesMakeResponse::call($ctx);
    ...
    {
        $preset = new EuroRatesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EuroRatesSpec([]),
            'response' => new EuroRatesResponse([]),
            'result' => new EuroRatesResult([]),
        ...
        [$got, $err] = EuroRatesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EuroRatesResult([])]);
        [, $err] = EuroRatesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EuroRatesSpec([]), 'result' => null]);
        [, $err] = EuroRatesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EuroRatesSpec(['step' => 's']),
            'result' => new EuroRatesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EuroRatesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EuroRatesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EuroRatesSpec(['step' => 's']),
            'result' => new EuroRatesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EuroRatesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EuroRatesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EuroRatesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EuroRatesSpec([]),
            'result' => new EuroRatesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EuroRatesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EuroRatesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EuroRatesError('boom', 'boom');
        $utility->fetcher = function (EuroRatesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EuroRatesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EuroRatesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EuroRatesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EuroRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EuroRatesResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EuroRatesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EuroRatesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EuroRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EuroRatesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EuroRatesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EuroRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EuroRatesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EuroRatesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EuroRatesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EuroRatesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EuroRatesResult(['ok' => false])]);
        $this->expectException(EuroRatesError::class);
        EuroRatesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EuroRatesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EuroRatesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        EuroRatesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EuroRatesBaseFeature();
        $b = new EuroRatesBaseFeature();
        EuroRatesFeatureAdd::call($ctx, $a);
        EuroRatesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EuroRatesBaseFeature
    {
        $f = new EuroRatesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EuroRatesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EuroRatesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EuroRatesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EuroRatesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EuroRatesResponse(['headers' => null]),
            'result' => new EuroRatesResult([]),
        ]);
        EuroRatesResultHeaders::call($ctx);
