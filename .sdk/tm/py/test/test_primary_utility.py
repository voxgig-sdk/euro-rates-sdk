...
from projectname_sdk import EuroRatesSDK
from projectname_sdk.core.spec import EuroRatesSpec
from projectname_sdk.core.result import EuroRatesResult
from projectname_sdk.core.response import EuroRatesResponse
from projectname_sdk.core.operation import EuroRatesOperation
from projectname_sdk.core.error import EuroRatesError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import EuroRatesBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return EuroRatesError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = EuroRatesSDK.test(None, None)
        ...
        class TestInitFeature(EuroRatesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(EuroRatesBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EuroRatesSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = EuroRatesSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = EuroRatesSDK.test(None, setup_opts)
