# EuroRates SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, EuroRatesError):
        errmsg = err.msg
    ...
    msg = "EuroRatesSDK: " + opname + ": " + errmsg
    ...
    sdk_err = EuroRatesError("", msg, ctx)
