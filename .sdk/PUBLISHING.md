...
|---|---|---|
| `ts/` | @voxgig-sdk/euro-rates-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/euro-rates-sdk \
      --repository voxgig-sdk/euro-rates-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/euro-rates-sdk` shows it, and
`npm trust revoke @voxgig-sdk/euro-rates-sdk --id=<id>` removes it.
