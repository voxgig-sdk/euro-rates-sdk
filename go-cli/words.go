...
func registerSDKWords(r *eng.Registry, client *sdk.EuroRatesSDK) {
...
func runOp(client *sdk.EuroRatesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
