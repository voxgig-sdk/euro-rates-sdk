# EuroRates Ruby SDK Reference

Complete API reference for the EuroRates Ruby SDK.
...
#### `EuroRatesSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
result, err = client.ExchangeRate.load({ "id" => "exchange_rate_id" })
```
