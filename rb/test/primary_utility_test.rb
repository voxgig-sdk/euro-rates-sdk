...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = EuroRatesOmni.make_runner(TEST_JSON_FILE, EuroRatesSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : EuroRatesOmni.errify(err)
    end
