...
from eurorates_sdk.utility import register

# Load features
from eurorates_sdk.feature.base_feature import EuroRatesBaseFeature
from eurorates_sdk.features import _has_feature, _make_feature
...
class EuroRatesSDK:
    ...
    def get_utility(self):
        return EuroRatesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EuroRatesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Currency(self, data=None) -> "CurrencyEntity":
        ...
        from eurorates_sdk.entity.currency_entity import CurrencyEntity
    ...
    def ExchangeRate(self, data=None) -> "ExchangeRateEntity":
        ...
        from eurorates_sdk.entity.exchange_rate_entity import ExchangeRateEntity
