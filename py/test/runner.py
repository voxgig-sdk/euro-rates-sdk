...
class EuroRatesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EuroRatesTestRunner.getenv("EURORATES_TEST_LIVE")
        override = EuroRatesTestRunner.getenv("EURORATES_TEST_OVERRIDE")
        ...
        explain = EuroRatesTestRunner.getenv("EURORATES_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["EURORATES_TEST_EXPLAIN"] = explain
