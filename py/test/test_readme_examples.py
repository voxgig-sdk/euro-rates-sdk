# EuroRates SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EuroRatesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EuroRatesSDK(...) and EuroRatesSDK.test(...) become
#      EuroRatesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "eurorates_sdk"
_SDK_CLASS = "EuroRatesSDK"
